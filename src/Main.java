...
public class Main extends JFrame {
	...
	public Main() {
		...
		lblBackground.setIcon(new ImageIcon(Main.class.getResource("/Image/Image 650.jpg")));
		lblBackground.setHorizontalAlignment(SwingConstants.CENTER);
		
		lblP1 = new JLabel("");
		lblP1.setIcon(new ImageIcon(Main.class.getResource("/Image/player 1.png")));
		lblP1.setBounds(1093, 253, 50, 50);
		contentPane.add(lblP1);
		
		lblP3 = new JLabel("");
		lblP3.setIcon(new ImageIcon(Main.class.getResource("/Image/player 3.png")));
		lblP3.setBounds(1093, 378, 50, 50);
		contentPane.add(lblP3);
		
		lblP2 = new JLabel("");
		lblP2.setIcon(new ImageIcon(Main.class.getResource("/Image/player 2.png")));
		lblP2.setBounds(1093, 314, 50, 50);
		contentPane.add(lblP2);
		
		lblP4 = new JLabel("");
		lblP4.setIcon(new ImageIcon(Main.class.getResource("/Image/player 4.png")));
		lblP4.setBounds(1093, 441, 50, 50);
		contentPane.add(lblP4);
		
		lblP5 = new JLabel("");
		lblP5.setIcon(new ImageIcon(Main.class.getResource("/Image/player 5.png")));
		lblP5.setBounds(1093, 504, 50, 50);
		contentPane.add(lblP5);
		
		lblP6 = new JLabel("");
		lblP6.setIcon(new ImageIcon(Main.class.getResource("/Image/player 6.png")));
		...
		dsBtnNxt.setIcon(new ImageIcon(Main.class.getResource("/Image/player 1.png")));
	...
	public void Dice(){
		...
		lblDice.setIcon(new ImageIcon(Main.class.getResource(location)));
	...
	public void Display(){
		...
		dsBtn.setIcon(new ImageIcon(Main.class.getResource("/Image/player "+String.valueOf(player)+".png")));
		...
		dsBtnNxt.setIcon(new ImageIcon(Main.class.getResource("/Image/player "+String.valueOf(pTurn)+".png")));
	}
	...
	public void RemoveImage(int x){
		...
		if(PlayerPos != -1){
			...
			System.out.println("Block matched at "+x);
		}
